...
public class JailScript : MonoBehaviour
{
    ...
    {
        int beforeJailPos = this.player.position; //wont be needed but is useful to have for debugging purposes. 
        this.player.position = 11;
        bool playerPaid = false;
        int player.turnsToWait = 0;
